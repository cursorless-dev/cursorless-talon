...
scope_type_compound = Compound(
    ...
    value_func=lambda node, extras: containing_scope.cursorless_scope_type(extras),
)
...
surrounding_pair_scope_types = containing_scope.surrounding_pair_scope_types
...
first_last_compound = Compound(
    spec="(first | last) <number_small> <scope_type>",
    name="first_last",
    extras=[
...
containing_scope_compound = Compound(
    ...
    value_func=lambda node, extras: containing_scope.cursorless_containing_scope(extras),
)
