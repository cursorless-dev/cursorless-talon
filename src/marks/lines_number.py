...
directions = [
    CustomizableTerm("row", "modulo100", "modulo100", lambda number: number - 1),
    CustomizableTerm("up", "relativeUp", "relative", lambda number: -number),
    CustomizableTerm("down", "relativeDown", "relative", lambda number: number),
]
